...
def get_pixel_dist(pixel, red, green, blue):
    ...
    """
    red_cal = (red - pixel.red) ** 2
    green_cal = (green - pixel.green) ** 2
    blue_cal = (blue - pixel.blue) ** 2
    color_distance = (red_cal + green_cal + blue_cal) ** 0.5
...
def get_average(pixels):
    ...
    average = []
    average.append(avg_red)
    average.append(avg_green)
    average.append(avg_blue)
    return average
...
def get_best_pixel(pixels):
    ...
    for pixel_1 in pixels:
        distance = get_pixel_dist(pixel_1, r, g, b)
